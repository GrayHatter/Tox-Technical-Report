...
another user, they need to obtain their long term public key. 
...
user must make sure however that the Tox ID they add belongs to his friend and 
not an impersonator.
...
Users who are not in the friends list of a certain user will not be able to connect to them.
